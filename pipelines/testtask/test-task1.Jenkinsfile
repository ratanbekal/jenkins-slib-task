node {
    ...
    stage("Slib-Ex1-Test-2-Stage") {
        getAPIsecret secret:'laika',url:'https://ugbdxukak0.execute-api.us-east-1.amazonaws.com/default/fakeCredentials',api-token:'v6PxYYLe8rhKftISrfFM42vTNTIxeUt97JKgT1y5'
        {
