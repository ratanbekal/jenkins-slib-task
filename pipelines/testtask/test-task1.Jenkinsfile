node {
     ...
     stage("Slib-Ex1-Test-2-Stage") {
        getAPIsecret apitoken:'v6PxYYLe8rhKftISrfFM42vTNTIxeUt97JKgT1y5',secret:"laika",url:"https://ugbdxukak0.execute-api.us-east-1.amazonaws.com/default/fakeCredentials"
        {
                 if ( env.SECRET_NAME =="VALUE" && env.SECRET_PASSWORD== "VALUE"){
                         println(env.SECRET_NAME)
                         println(env.SECRET_PASSWORD)
